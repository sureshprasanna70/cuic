...
DD DATE
 <tr>
  ...
  <tr>
<td colspan="4"><b><u>Affix your recent passport size photo ---></u></b></td>
...
<td>'.mysql_real_escape_string($_POST["dop"]).'</td>
  ...
  <br>
I hereby acknowledge that the above given data is true to my knowledge and if proved false I accept
...
if(mysql_error()==$err)
{
  echo '<html><link rel="stylesheet" type="text/css" href="css/bootstrap.css">

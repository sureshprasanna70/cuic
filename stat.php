...
<body>
<div class="container">
<table class="lis table-striped" border= "2px" align="center">
<tr class="ttitle">
	<td colspan="4">
...
<tr class="ttitle"><td colspan="4"><b>ME CIVIL</b></td></tr>  
<?stat_printer($dept_me_civil,$tot_me_civil,$placed_me_civil);?>
<tr class="ttitle"><td colspan="4"><b>ME MECHANICAL</b></td></tr> 
<?stat_printer($dept_me_mech,$tot_me_mech,$placed_me_civil);?>
<tr class="ttitle"><td colspan="4"><b>ME ECE</b> </td></tr> 
<?stat_printer($dept_me_ece,$tot_me_ece,$placed_me_ece);?>
<tr class="ttitle"><td colspan="4"><b>ME EEE</b></td></tr> 
<?stat_printer($dept_me_eee,$tot_me_eee,$placed_me_eee);?>
<tr class="ttitle"><td colspan="4">ME CSE</td></tr> 
<?stat_printer($dept_me_cse,$tot_me_cse,$placed_me_cse);?>
<tr class="ttitle"><td colspan="4">M.E PRINTING</td></tr>
<tr>
	<td class="tcontent"><?echo $dept_me_printing ;?></td>
	<td class="tcontent"><?echo $tot_me_print ;?></td>
	<td class="tcontent"><?echo $placed_me_print ;?></td>
	<td class="tcontent"><?echo floor(($placed_me_print/$tot_me_print)*100);?></td>
</tr>
<tr class="ttitle"><td colspan="4">M.TECH</td></tr> 
<?stat_printer($dept_mtech,$tot_mtech,$placed_mtech);?>
<tr class="ttitle"><td colspan="4">MCA</td></tr>
<tr>
	<td class="tcontent">MASTER OF COMPUTER APPLICATION</td>
	<td class="tcontent"><?echo $mca_tot ;?></td>
	<td class="tcontent"><?echo $mca_placed ;?></td>
	<td class="tcontent"><?echo floor(($mca_placed/$mca_tot)*100);?></td>
</tr>
<tr class="ttitle"><td colspan="4">MBA</td></tr> 
<?stat_printer($dept_mba,$tot_mba,$placed_mba);?>
<tr class="ttitle"><td colspan="4">M.SC</td></tr> 
<?stat_printer($dept_msc,$tot_msc,$placed_msc);?>
<tr class="ttitle"><td colspan="4">M.SC (Integrated) </td></tr> 
<?stat_printer($dept_integ,$tot_integ,$placed_integ);?>
<tr class="ttitle"><td colspan="4">Alagappa College of Technology</td></tr>
<tr class="ttitle"><td colspan="4">B.Tech</td></tr> 
<?stat_printer($act_btech,$act_tot,$act_placed);?>
<tr class="ttitle"><td colspan="4">M.Tech</td></tr> 
<?stat_printer($act_pg,$act_pg_tot,$act_pg_placed);?>
<tr class="ttitle"><td colspan="4">Madras Insitute of Technology</td></tr>
<tr class="ttitle"><td colspan="4">B.E</td></tr>
<?stat_printer($mit_ug,$mit_ug_tot,$mit_ug_placed);?>
<tr class="ttitle"><td colspan="4">M.E</td></tr>
<?stat_printer($mit_pg,$mit_pg_tot,$mit_pg_placed);?>
<tr class="ttitle">
	<td class="ttitle">UG TOTAL (ANNA UNIV.)</td>
	<td>2094</td>
<td>1377</td>
<td>65.76</td>
</tr>

...
<script src="js/bootstrap-datetimepicker.min.js"></script>
 ...
 <script type="text/javascript">
  $(function() {
   ...
   if(document.tnslpp.psslc.value.length<5)
   {
    alert('Provide proper year of SSLC passing');
    document.tnslpp.ysslc.focus();
    return false;
  ...
  if(document.tnslpp.y2.value.length<5)
   ...
   if(document.tnslpp.bname.value=="other" && document.tnslpp.bname1.value="")
   {
    alert('Provide proper bank name');
    document.tnslpp.bname.focus();
    return false;
   }
...
<div id="container">
<div class="banner">
	Tamilnadu State Level Placement Program
</div>
<br><br><br><br><br><br>
<div class="alert alert-error">
  Important:Bring the PDF in printed format that will be generated after successful form  submission
</div>
<form name="tnslpp" method="post" class="reg"  action="validate"  onsubmit="return(safety());">
	<fieldset>
...
<div class="row-fluid">
  ...
  <div class="span2 offset2">
    <label>Bank</label><select name="bname">
